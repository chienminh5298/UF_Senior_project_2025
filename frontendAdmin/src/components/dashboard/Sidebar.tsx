    ...
    <div className="w-16 sm:w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
      ...
      <div className="p-3 sm:p-6">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-white text-gray-900 flex items-center justify-center">
            ...
            return (
              <li key={item.id}>
                ...
                >
                  ...
                  <span className="hidden sm:inline flex-1 text-left">{item.label}</span>
                </button>
              </li>
            )
          })}
